        ...
        <div class="container">
            <div class="box">
                <div class="box-title">
                    ...
                    <div>
                        <a href="auditoria.php" class="btn btn-primary">Por fecha</a>
                        <a href="auditoria.php?user_id=<?= secure_data($_SESSION[$_SESSION["CFGURL"]]["ssuser_id"]) ?>" class="btn btn-primary">Mis términos</a>
                    </div>
                </div>
