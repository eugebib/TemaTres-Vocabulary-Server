...
function checkDataInstall($array=array())
{
	...
	if (strlen($array["dccontributor"])>1) {
		$installData["dccontributor"]=$array["dccontributor"];
	} else {
	...
	if (strlen($array["author"])>1) {
		...
		$instalChk["error_msg"].='<p class="alert alert-danger" role="alert">'.MSG_errorPostData.': <strong>'.LABEL_Entidad.'</strong></p>';
	}
...
function SQLtematres($DBCFG,$DB,$arrayInstallData=array())
{
	...
	$result1 = $DB->Execute("CREATE TABLE `".$prefix."config` (
		...
		$contributor = ($arrayInstallData['dccontributor']) ? $DB->qstr(trim($arrayInstallData["dccontributor"]),get_magic_quotes_gpc()) : "'TemaTres'";
		...
		$result10 = $DB->Execute("INSERT INTO `".$prefix."values` (`value_id`, `value_type`, `value`, `value_order`, `value_code`) VALUES (2, 't_relacion', 'Termino relacionado', NULL, 'TR'),
				...
				(41,'METADATA', $contributor, 2,'dc:contributor'),
...
function HTMLformInstall($lang_install)
{
	...
	<div class="form-group">
	  ...
	  <div class="col-md-5">
	  <input id="title" name="title" placeholder="'.ucfirst(LABEL_Titulo).'" class="form-control input-md" required="" type="text" value="' . ($_POST["title"] ?: '') .'">
	  </div>
	</div>

	<!-- Text input-->
	<div class="form-group">
	  <label class="col-md-4 control-label" for="author">'.ucfirst(LABEL_Entidad).'</label>
	  <div class="col-md-5">
	  <input id="author" name="author" placeholder="'.ucfirst(LABEL_Entidad).'" class="form-control input-md" required="" type="text" value="'. ($_POST["author"] ?: '') .'">
	  </div>
	</div>

	<!-- Text input-->
	<div class="form-group">
	  <label class="col-md-4 control-label" for="dccontributor">'.ucfirst(LABEL_Autores).'</label>
	  <div class="col-md-5">
	  <input id="author" name="dccontributor" placeholder="'.ucfirst(LABEL_Autores).'" class="form-control input-md" required="" type="text" value="'. ($_POST["dccontributor"] ?: '') .'">
	  </div>
	</div>
	...
	<div class="form-group">
	  ...
	  <div class="col-md-4">
	  <input id="name" name="name" placeholder="'.ucfirst(LABEL_nombre).'" class="form-control input-md" required="" type="text" value="'. ($_POST["name"] ?: '') .'">
	  </div>
	</div>
	...
	<div class="form-group">
	  ...
	  <div class="col-md-4">
	  <input id="s_name" name="s_name" placeholder="'.ucfirst(LABEL_apellido).'" class="form-control input-md" required="" type="text" value="'. ($_POST["s_name"] ?: '') .'">
	  </div>
	</div>
	...
	<div class="form-group">
	  ...
	  <div class="col-md-4">
	  <input id="mail" name="mail" placeholder="'.ucfirst(LABEL_mail).'" class="form-control input-md" required="" type="email" value="'. ($_POST["mail"] ?: '') .'">
	  </div>
	</div>
	...
	<div class="form-group">
	  ...
	  <div class="col-md-4">
	    <input id="mdp" name="mdp"  data-minlength="4" placeholder="'.ucfirst(LABEL_pass).'" class="form-control input-md" required="" type="password">
			<span class="help-block">'.ucfirst(sprintf(MSG_lengh_error,5)).'</span>
	  </div>
	</div>
