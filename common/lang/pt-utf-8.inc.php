...
define("LABEL_BuscaTermino","procurar termo");
define("LABEL_Buscar","procurar");
...
define('LABEL_FORM_lists','Listas de termos');
...
define('LABEL_update1_4x1_5','Atualizar Tematres (1.4 -> 1.5)');
...
define('LABEL_update1_5x1_6','Atualizar Tematres (1.5 -> 1.6)');
...
define('LABEL_type2filter','filtrar termos');
...
define('LABEL_termsXdeepLevel','termos conforme nível de profundidade');
...
define('LABEL_bulkReplace','alterações globais (procurar e substituir)');
define('LABEL_searchFor','Texto a procurar');
define('LABEL_replaceWith','substituir com');
...
define('LABEL_Preview','vista prévia');
#v.2.2
