...
define("MENU_Usuarios","gestión de usuarios");
...
define("MENU_AgregarTE","término específico");
define("MENU_AgregarTR","término relacionado");
define("MENU_AgregarUP","término no preferido");
...
define("LABEL_AgregarTE","Creación de un NUEVO término específico de ");
...
define("LABEL_Relacionar","Relacionar");
...
define("LABEL_NO_vocabulario_referencia","no se encuentran vocabularios de referencia para establecer relación terminológica");
...
define("LABEL_existAgregarTE","Subordinar un término existente (libre) a %s ");
...
define("LABEL_configTypeNotes","editor de notas");
...
define('LABEL_update1_4x1_5','Actualizar Tematres (1.4 -> 1.5)');
...
define('LABEL_update1_5x1_6','Actualizar Tematres (1.5 -> 1.6)');
...
define('MENU_glossConfig','configuración de autoglosario');
define('LABEL_generateAutoGlossary','generación de auto-glosario');
define('LABEL_AlphaPDF','Lista alfabética (PDF)');
define('LABEL_SistPDF','Lista sistemática (PDF)');
