...
$rows = '
	<form role="form" name="login" id="form-users" data-toggle="validator" action="admin.php" method="post">
		<div class="row">
			<div class="col-sm-12">
	...
	if (isset($dato_user["id"])) {
		$rows .= '
			<input type="hidden" name="useactua" id="useactua" value="'.$dato_user["id"].'"/>
			<input type="hidden" name="userTask" id="userTask" value="M"/>';
	} else {
		$rows .= '
			<input type="hidden" name="userTask" id="userTask" value="A"/>';
	}
