...
function HTMLformMappedTermReport($array)
{
	GLOBAL $CFG;
	$rows.='
		<form class="" role="form" name="mappedreport" id="mappedreport" action="index.php" method="get">
			<div class="row">
	    		<div class="col-sm-12">
...
function HTMLformNullNotesTermReport($array)
{
	...
	$LabelNC = LABEL_NC;
	$rows   .= '
		<form class="" role="form" name="NULLnotesreport" id="NULLnotesreport" action="index.php" method="get">
			<div class="row">
	    		<div class="col-sm-12">
	...
	<form class="" role="form"  name="export" action="xml.php" method="get" target="_blank">
		<div class="row">
		    ...
		    <div class="col-lg-7">
		        ...
		        <div class="panel panel-default">
            		<div class="panel-body form-horizontal">
						<div class="form-group"><label class="col-sm-3 control-label" for="report_tvocab_id" accesskey="t">'.ucfirst(FORM_LABEL_format_export).'</label>
							<div class="col-sm-9">
