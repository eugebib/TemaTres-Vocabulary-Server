...
$rows.= '
	<form role="form" name="login" id="form-users" data-toggle="validator" action="login.php" method="post">
		<div class="row">
			<div class="col-sm-12">'.
				$row_log.'
				<legend>'.MENU_MisDatos.'</legend>
			</div>
			<div class="col-lg-7">
...
$rows.='				<div class="form-group">
		...
		<input type="hidden" name="taskUser"  value="actuaDatos"/>
	</form>';
