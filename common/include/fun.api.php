...
function fetchExactTerm($string)
{
	...
	*/
	...
	//Retrieve random term data. You can filter terms with specific type of note
	...
	//Retrieve term data about terms created or mod since date
...
// Devuelve detalles del vocabulario
